...
String myUserid;
String myRole;
String myMethod; // email or google
...
Future<bool> createOrGetUserInDb(
  ...
  try {
    ...
    if (userModel != null) {
      ...
      myShortname = userModel.userName;
      myName = userModel.userName;
      myEmail = userModel.userEmail;
      myImageurl = userModel.imageUrl;
      myUserid = userModel.id;
      myRole = userModel.role;
      myMethod = methodForm;
      // Only taking the first part of the name, i.e., First Name
      if (myShortname.contains(" ")) {
        myShortname = myShortname.substring(0, myShortname.indexOf(" "));
      }
    }
    return true;
  } catch (e) {
